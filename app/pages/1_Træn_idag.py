"""Træn idag — generer og marker dagens hjemmetræning."""
...
from core.database import (
    get_players, get_observations, get_daily_plan, save_daily_plan, mark_plan_completed,
)
...
st.set_page_config(page_title="Træn idag – KP13", layout="wide")
apply_theme()
